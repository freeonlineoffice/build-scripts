...
apt-get install -y git build-essential devscripts libkrb5-dev openssl g++ libssl-dev libcap2-dev libtool m4 automake \
                   ...
                   curl rsync libfontconfig1-dev gperf libnss3-dev bison flex zip inotify-tools openssh-client \
